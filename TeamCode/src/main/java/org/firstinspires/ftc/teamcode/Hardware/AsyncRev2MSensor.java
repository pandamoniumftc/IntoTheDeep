...
public class AsyncRev2MSensor implements OpModeManagerNotifier.Notifications, Runnable{
    ...
    public AsyncRev2MSensor(Rev2mDistanceSensor sensor){
        ...
        try {
            ...
            //Probably
            //Hopefully
            Field field = getField(sensor.getClass(), "deviceClient");
        ...
        try {
            ...
            module = (LynxModule) getField(device.getClass(), "module").get(device);
        } catch (IllegalAccessException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            bus = (int) getField(device.getClass(), "bus").get(device);
        } catch (IllegalAccessException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            i2cAddr = (I2cAddr) getField(device.getClass(), "i2cAddr").get(device);
        } catch (IllegalAccessException e) {
            e.printStackTrace();
        }
