...
public class PushSampleIntoZoneCommand extends SequentialCommandGroup {
    public PushSampleIntoZoneCommand() {
        super(
                new SplineCommand(new Pose2d(), new Point(), new Point(), BezierCurvePath.HeadingBehavior.STATIC), // move from bar to in front of sample
                new SplineCommand(new Pose2d(), new Point(), new Point(), BezierCurvePath.HeadingBehavior.STATIC), // pushes sample and goes in front of next
                new SplineCommand(new Pose2d(), new Point(), new Point(), BezierCurvePath.HeadingBehavior.STATIC), // repeats
